...
When generating the file, do not overwrite the contents of existing files. If necessary, list the files in the docs/features/ folder to find the last file <N>_PLAN.md and add +1 to N to get the name of the new file.